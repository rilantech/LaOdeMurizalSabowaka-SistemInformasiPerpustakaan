...
class WaitingRequestManager implements Request.NetworkRequestCompleteListener {
    ...
    public synchronized boolean maybeAddToWaitingRequests(com.android.volley.Request<?> r7) {
        /*
            ...
            java.util.Map<java.lang.String, java.util.List<com.android.volley.Request<?>>> r1 = r6.mWaitingRequests     // Catch:{ all -> 0x0054 }
        ...
        L_0x001f:
            ...
            java.util.Map<java.lang.String, java.util.List<com.android.volley.Request<?>>> r4 = r6.mWaitingRequests     // Catch:{ all -> 0x0054 }
            r4.put(r0, r1)     // Catch:{ all -> 0x0054 }
            boolean r4 = com.android.volley.VolleyLog.DEBUG     // Catch:{ all -> 0x0054 }
            ...
            com.android.volley.VolleyLog.d(r4, r5)     // Catch:{ all -> 0x0054 }
        L_0x003a:
            monitor-exit(r6)
            return r2
        L_0x003c:
