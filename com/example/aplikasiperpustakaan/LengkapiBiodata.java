...
public class LengkapiBiodata extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.activity_lengkapi_biodata);
        ...
        this.imageView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                LengkapiBiodata lengkapiBiodata = LengkapiBiodata.this;
                lengkapiBiodata.startActivityForResult(i, lengkapiBiodata.MY_REQUEST_CODE);
            }
        });
        this.simpan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (LengkapiBiodata.this.nama.getText().toString().length() == 0 || LengkapiBiodata.this.bitmap == null) {
                    new SweetAlertDialog(LengkapiBiodata.this, 3).setContentText("Foto Profil / Nama Belum Lengkap!").show();
                    return;
                }
                LengkapiBiodata.this.setData.putString("session_nama", LengkapiBiodata.this.nama.getText().toString());
                LengkapiBiodata.this.setData.apply();
                LengkapiBiodata.this.startActivity(new Intent(LengkapiBiodata.this.getApplicationContext(), Halamanutama.class));
            }
        });
    }
