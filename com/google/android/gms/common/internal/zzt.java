...
public final class zzt {
    ...
    public static Intent zzb(String str, String str2) {
        ...
        Uri.Builder appendQueryParameter = Uri.parse("market://details").buildUpon().appendQueryParameter(UploadTaskParameters.Companion.CodingKeys.id, "com.google.android.gms");
