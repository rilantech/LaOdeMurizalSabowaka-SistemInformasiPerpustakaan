...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public long m183markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m195constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m182elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m181differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U  reason: not valid java name */
    public final long m180adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m195constructorimpl(LongSaturatedMathKt.m178saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
