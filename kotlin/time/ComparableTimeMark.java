...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark m41minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc  reason: not valid java name */
    long m42minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    ComparableTimeMark m43plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static ComparableTimeMark m44minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.m43plusLRDsOJo(Duration.m102unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m48compareToLRDsOJo($this.m42minusUwyO8pc(other), Duration.Companion.m152getZEROUwyO8pc());
        }
    }
}
