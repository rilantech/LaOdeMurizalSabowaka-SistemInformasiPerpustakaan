...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m38getAdjustmentUwyO8pc() {
    ...
    public TimeMark m39minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m189minusLRDsOJo(this, duration);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m37elapsedNowUwyO8pc() {
        return Duration.m84minusLRDsOJo(this.mark.m186elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m40plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m85plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
