...
public final class LongSaturatedMathKt {
    ...
    public static final long m178saturatingAddNuflL3o(long value, DurationUnit unit, long duration) {
        DurationUnit durationUnit = unit;
        Intrinsics.checkNotNullParameter(durationUnit, "unit");
        long durationInUnit = Duration.m95toLongimpl(duration, durationUnit);
        boolean z = true;
        if (((value - 1) | 1) == Long.MAX_VALUE) {
            return m177checkInfiniteSumDefinedPjuGub4(value, duration, durationInUnit);
        }
        if ((1 | (durationInUnit - 1)) != Long.MAX_VALUE) {
            z = false;
        }
        if (z) {
            return m179saturatingAddInHalvesNuflL3o(value, unit, duration);
        }
    ...
    private static final long m177checkInfiniteSumDefinedPjuGub4(long value, long duration, long durationInUnit) {
        if (!Duration.m81isInfiniteimpl(duration) || (value ^ durationInUnit) >= 0) {
            return value;
        }
    ...
    private static final long m179saturatingAddInHalvesNuflL3o(long value, DurationUnit unit, long duration) {
        long half = Duration.m52divUwyO8pc(duration, 2);
        long halfInUnit = Duration.m95toLongimpl(half, unit);
        if ((1 | (halfInUnit - 1)) == Long.MAX_VALUE) {
            return halfInUnit;
        }
        return m178saturatingAddNuflL3o(m178saturatingAddNuflL3o(value, unit, half), unit, Duration.m84minusLRDsOJo(duration, half));
    }

    private static final long infinityOfSign(long value) {
        return value < 0 ? Duration.Companion.m151getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.Companion.m150getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long valueNs, long origin, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (origin - 1)) == Long.MAX_VALUE) {
            return Duration.m102unaryMinusUwyO8pc(infinityOfSign(origin));
        }
    ...
    public static final long saturatingOriginsDiff(long origin1, long origin2, DurationUnit unit) {
        ...
        if ((((origin2 - 1) | 1) == Long.MAX_VALUE ? 1 : 0) == 0) {
            ...
            return Duration.m102unaryMinusUwyO8pc(infinityOfSign(origin2));
        }
    }
    ...
    private static final long saturatingFiniteDiff(long value1, long value2, DurationUnit unit) {
        ...
        if (durationUnit.compareTo(DurationUnit.MILLISECONDS) >= 0) {
            return Duration.m102unaryMinusUwyO8pc(infinityOfSign(result));
        }
        ...
        return Duration.m85plusLRDsOJo(DurationKt.toDuration(resultMs, DurationUnit.MILLISECONDS), DurationKt.toDuration(resultUnit, durationUnit));
    }
