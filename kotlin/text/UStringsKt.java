...
public final class UStringsKt {
    ...
    public static final String m22toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m24toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m23toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m21toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m409unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m672unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m488unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m567unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m488unboximpl();
        if (Integer.compareUnsigned(r0, UInt.m436constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m353boximpl(UByte.m359constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m488unboximpl();
        if (Integer.compareUnsigned(r0, UInt.m436constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m616boximpl(UShort.m622constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m436constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m436constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m436constructorimpl(UInt.m436constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, beforeAdding) < 0) {
                return null;
            }
        }
        return UInt.m430boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m515constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m515constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m515constructorimpl(ULong.m515constructorimpl(((long) UInt.m436constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m509boximpl(result);
    }
}
