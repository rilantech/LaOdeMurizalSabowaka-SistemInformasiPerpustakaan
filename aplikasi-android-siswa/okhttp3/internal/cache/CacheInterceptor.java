...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(response.header(HttpHeaderParser.HEADER_CONTENT_TYPE), response.body().contentLength(), Okio.buffer(cacheWritingSource))).build();
    }
    ...
    static boolean isContentSpecificHeader(String fieldName) {
        return "Content-Length".equalsIgnoreCase(fieldName) || "Content-Encoding".equalsIgnoreCase(fieldName) || HttpHeaderParser.HEADER_CONTENT_TYPE.equalsIgnoreCase(fieldName);
    }
}
