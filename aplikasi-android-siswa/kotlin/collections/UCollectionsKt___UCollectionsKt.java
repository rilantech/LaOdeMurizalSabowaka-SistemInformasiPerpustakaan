...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> $this$toUByteArray) {
        ...
        byte[] result = UByteArray.m411constructorimpl($this$toUByteArray.size());
        int index = 0;
        for (UByte r3 : $this$toUByteArray) {
            UByteArray.m422setVurrAj0(result, index, r3.m409unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> $this$toUIntArray) {
        ...
        int[] result = UIntArray.m490constructorimpl($this$toUIntArray.size());
        int index = 0;
        for (UInt r3 : $this$toUIntArray) {
            UIntArray.m501setVXSXFK8(result, index, r3.m488unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> $this$toULongArray) {
        ...
        long[] result = ULongArray.m569constructorimpl($this$toULongArray.size());
        int index = 0;
        for (ULong r3 : $this$toULongArray) {
            ULongArray.m580setk8EXiF4(result, index, r3.m567unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> $this$toUShortArray) {
        ...
        short[] result = UShortArray.m674constructorimpl($this$toUShortArray.size());
        int index = 0;
        for (UShort r3 : $this$toUShortArray) {
            UShortArray.m685set01HTLdE(result, index, r3.m672unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> $this$sum) {
        ...
        for (UInt r2 : $this$sum) {
            sum = UInt.m436constructorimpl(sum + r2.m488unboximpl());
        }
        return sum;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> $this$sum) {
        ...
        for (ULong r3 : $this$sum) {
            sum = ULong.m515constructorimpl(sum + r3.m567unboximpl());
        }
        return sum;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> $this$sum) {
        ...
        for (UByte r2 : $this$sum) {
            sum = UInt.m436constructorimpl(UInt.m436constructorimpl(r2.m409unboximpl() & UByte.MAX_VALUE) + sum);
        }
        return sum;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> $this$sum) {
        ...
        for (UShort r2 : $this$sum) {
            sum = UInt.m436constructorimpl(UInt.m436constructorimpl(65535 & r2.m672unboximpl()) + sum);
        }
        return sum;
    }
}
