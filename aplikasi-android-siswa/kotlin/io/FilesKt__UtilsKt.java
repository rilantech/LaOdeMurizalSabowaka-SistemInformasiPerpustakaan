...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final String getExtension(File $this$extension) {
        ...
        Intrinsics.checkNotNullExpressionValue(name, NameValue.Companion.CodingKeys.name);
    ...
    public static final String getInvariantSeparatorsPath(File $this$invariantSeparatorsPath) {
        ...
        if (File.separatorChar != '/') {
            ...
            Intrinsics.checkNotNullExpressionValue(path, UploadFile.Companion.CodingKeys.path);
        ...
        Intrinsics.checkNotNullExpressionValue(path2, UploadFile.Companion.CodingKeys.path);
        return path2;
    }
