...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m340boximpl(Object obj) {
        return new Result(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Object m341constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m342equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).m350unboximpl());
    }
    ...
    public static int m346hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public int hashCode() {
        return m346hashCodeimpl(this.value);
    }
    ...
    public static final boolean m348isSuccessimpl(Object arg0) {
        return !(arg0 instanceof Failure);
    }

    /* renamed from: isFailure-impl  reason: not valid java name */
    public static final boolean m347isFailureimpl(Object arg0) {
        return arg0 instanceof Failure;
    }

    /* renamed from: getOrNull-impl  reason: not valid java name */
    private static final T m345getOrNullimpl(Object arg0) {
        if (m347isFailureimpl(arg0)) {
            return null;
        }
        return arg0;
    }
    ...
    public static final Throwable m344exceptionOrNullimpl(Object arg0) {
    ...
    public static String m349toStringimpl(Object arg0) {
        if (arg0 instanceof Failure) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m341constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m341constructorimpl(ResultKt.createFailure(exception));
        }
    }
