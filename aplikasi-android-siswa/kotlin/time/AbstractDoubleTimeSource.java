...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m27minusLRDsOJo(long duration) {
            return ComparableTimeMark.DefaultImpls.m44minusLRDsOJo(this, duration);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m25elapsedNowUwyO8pc() {
            return Duration.m84minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark m30plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m85plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m28minusUwyO8pc(ComparableTimeMark other) {
            ...
            } else if (Duration.m54equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m81isInfiniteimpl(this.offset)) {
                return Duration.Companion.m152getZEROUwyO8pc();
            } else {
                long offsetDiff = Duration.m84minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
                long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
                return Duration.m54equalsimpl0(startedAtDiff, Duration.m102unaryMinusUwyO8pc(offsetDiff)) ? Duration.Companion.m152getZEROUwyO8pc() : Duration.m85plusLRDsOJo(startedAtDiff, offsetDiff);
            }
        }

        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) other).timeSource) && Duration.m54equalsimpl0(m28minusUwyO8pc((ComparableTimeMark) other), Duration.Companion.m152getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m77hashCodeimpl(Duration.m85plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m98toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m152getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
