...
public abstract class OneDReader implements Reader {
    ...
    private com.google.zxing.Result doDecode(com.google.zxing.BinaryBitmap r22, java.util.Map<com.google.zxing.DecodeHintType, ?> r23) throws com.google.zxing.NotFoundException {
        ...
        L_0x0076:
            ...
            java.lang.Integer r6 = java.lang.Integer.valueOf(r16)     // Catch:{ ReaderException -> 0x00cf }
            r0.putMetadata(r15, r6)     // Catch:{ ReaderException -> 0x00cf }
            com.google.zxing.ResultPoint[] r6 = r0.getResultPoints()     // Catch:{ ReaderException -> 0x00cf }
            if (r6 == 0) goto L_0x00d6
            com.google.zxing.ResultPoint r15 = new com.google.zxing.ResultPoint     // Catch:{ ReaderException -> 0x00cf }
            r16 = r2
            float r2 = (float) r1
            r18 = r6[r5]     // Catch:{ ReaderException -> 0x00cb }
            ...
            r15 = 1
            r17 = r6[r15]     // Catch:{ ReaderException -> 0x00c7 }
            float r17 = r17.getX()     // Catch:{ ReaderException -> 0x00c7 }
            float r2 = r2 - r17
            float r2 = r2 - r19
            r17 = r6[r15]     // Catch:{ ReaderException -> 0x00c7 }
            float r1 = r17.getY()     // Catch:{ ReaderException -> 0x00c7 }
            r5.<init>(r2, r1)     // Catch:{ ReaderException -> 0x00c7 }
            r6[r15] = r5     // Catch:{ ReaderException -> 0x00c7 }
            goto L_0x00d6
        L_0x00c7:
            r0 = move-exception
            goto L_0x00dd
