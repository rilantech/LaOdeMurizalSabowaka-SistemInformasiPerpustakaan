...
public class Detail_pengembalian_buku extends AppCompatActivity {
    ...
    TextView tvNIS;
    TextView tvNama;
    TextView waktu_kembali;

    /* access modifiers changed from: protected */
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView((int) R.layout.activity_detail_pengembalian_buku);
        ...
        this.waktu_kembali = (TextView) findViewById(R.id.waktu_kembali);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Detail_pengembalian_buku.this);
                builder.setMessage("Yakin Ingin Logout ?");
                builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogInterface, int position) {
                        HalamanLogin.preferenceHelper.putIsLogin(false);
                        Intent intent = new Intent(Detail_pengembalian_buku.this, HalamanLogin.class);
                        intent.addFlags(268468224);
                        Detail_pengembalian_buku.this.startActivity(intent);
                        Detail_pengembalian_buku.this.finish();
                    }
                });
    ...
    public void getData() {
        Volley.newRequestQueue(this).add(new StringRequest(1, new Configurasi().baseUrl() + "api/detail_pengembalian_buku.php", new Response.Listener<String>() {
            public void onResponse(String response) {
                try {
                    ...
                    String gwaktu_kembali = jsonObject.getString("waktu_kembali");
                    ((RequestBuilder) ((RequestBuilder) Glide.with(Detail_pengembalian_buku.this.getApplicationContext()).load(new Configurasi().baseUrl() + "public/img/" + gsampul).diskCacheStrategy(DiskCacheStrategy.NONE)).skipMemoryCache(true)).into(Detail_pengembalian_buku.this.sampul);
                    Detail_pengembalian_buku.this.kode_buku.setText(gkode_buku);
                    Detail_pengembalian_buku.this.judul.setText(gjudul);
                    Detail_pengembalian_buku.this.nama_pengarang.setText(gnama_pengarang);
                    Detail_pengembalian_buku.this.letak_buku.setText(gletak_buku);
                    Detail_pengembalian_buku.this.mulai_pinjam.setText(gmulai_pinjam);
                    Detail_pengembalian_buku.this.batas_pinjam.setText(gbatas_pinjam);
                    Detail_pengembalian_buku.this.waktu_kembali.setText(gwaktu_kembali);
            ...
            public Map<String, String> getParams() throws AuthFailureError {
                ...
                form.put(UploadTaskParameters.Companion.CodingKeys.id, Detail_pengembalian_buku.this.getIntent().getStringExtra("detail2"));
                return form;
            }
        });
    }
