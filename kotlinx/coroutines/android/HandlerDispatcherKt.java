...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m341constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), (String) null, 2, (DefaultConstructorMarker) null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m341constructorimpl(ResultKt.createFailure(th));
        }
    ...
    public static final void m230postFrameCallback$lambda6(CancellableContinuation $cont, long nanos) {
