...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m267catch(Flow<? extends T> $this$catch, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> action) {
        return FlowKt__ErrorsKt.m274catch($this$catch, action);
    }
    ...
    public static final <T> Flow<T> m268debounceHG0u8IE(Flow<? extends T> $this$debounce, long timeout) {
        return FlowKt__DelayKt.m270debounceHG0u8IE($this$debounce, timeout);
    }
    ...
    public static final <T> Flow<T> m269sampleHG0u8IE(Flow<? extends T> $this$sample, long period) {
        return FlowKt__DelayKt.m271sampleHG0u8IE($this$sample, period);
    }
