...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m270debounceHG0u8IE(Flow<? extends T> $this$debounce, long timeout) {
        return FlowKt.debounce($this$debounce, DelayKt.m223toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> m271sampleHG0u8IE(Flow<? extends T> $this$sample, long period) {
        return FlowKt.sample($this$sample, DelayKt.m223toDelayMillisLRDsOJo(period));
    }
}
