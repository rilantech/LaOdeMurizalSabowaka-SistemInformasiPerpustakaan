...
public final class DelayKt {
    ...
    public static final Object m222delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m223toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m223toDelayMillisLRDsOJo(long $this$toDelayMillis) {
        if (Duration.m48compareToLRDsOJo($this$toDelayMillis, Duration.Companion.m152getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m67getInWholeMillisecondsimpl($this$toDelayMillis), 1);
        }
        return 0;
    }
}
