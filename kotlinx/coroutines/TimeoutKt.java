...
public final class TimeoutKt {
    ...
    public static final <T> Object m226withTimeoutKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return withTimeout(DelayKt.m223toDelayMillisLRDsOJo(timeout), block, $completion);
    }
    ...
    public static final <T> Object m227withTimeoutOrNullKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return withTimeoutOrNull(DelayKt.m223toDelayMillisLRDsOJo(timeout), block, $completion);
    }
